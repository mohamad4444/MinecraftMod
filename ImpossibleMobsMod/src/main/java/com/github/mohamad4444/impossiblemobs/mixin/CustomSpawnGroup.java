 ...
 */
public enum CustomSpawnGroup implements StringIdentifiable {
	MONSTER("monster", 70, false, false, 128),
	ULTRA_MONSTER("ultra_monster", 1000, false, false, 128),
	 ...
	 */
	public static final com.mojang.serialization.Codec<CustomSpawnGroup> CODEC = StringIdentifiable.createCodec(CustomSpawnGroup::values);
	...
	private CustomSpawnGroup(String name, int spawnCap, boolean peaceful, boolean rare, int immediateDespawnRange) {
		this.name = name;
